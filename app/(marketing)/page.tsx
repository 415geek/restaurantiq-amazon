...
const contentByLang = {
  zh: {
    ...
    modal: {
      ...
      subtitle:
        'Enter your name and email to get the latest updates and access the demo dashboard immediately.',
      placeholders: {
        name: 'Your name',
        email: 'Email address',
      },
      ...
      termsBody: [
        ...
        'How we use it: to provision demo access, and improve the demo experience.',
