...
const docs: Record<string, string> = {
  ...
  ubereats: 'Set UBEREATS_CLIENT_ID, UBEREATS_ASYMMETRIC_KEY_ID and private key env (UBEREATS_PRIVATE_KEY_PEM / BASE64 / PATH) for client_assertion OAuth. For fallback, you may still use UBEREATS_CLIENT_SECRET or UBEREATS_BEARER_TOKEN + UBEREATS_USE_SERVER_TOKEN=true. Webhook endpoint: /api/webhooks/ubereats.',
...
export function IntegrationStatusPanel({
  ...
  const docsLocalized = lang === 'zh'
    ? {
        ...
        ubereats: '优先配置 UBEREATS_CLIENT_ID + UBEREATS_ASYMMETRIC_KEY_ID + 私钥（UBEREATS_PRIVATE_KEY_PEM / BASE64 / PATH）启用 client_assertion OAuth。也可回退使用 UBEREATS_CLIENT_SECRET，或使用 UBEREATS_BEARER_TOKEN + UBEREATS_USE_SERVER_TOKEN=true。建议同时配置 UBEREATS_STORE_IDS 与 UBEREATS_ORDERS_ENDPOINT_TEMPLATE。Webhook 地址：/api/webhooks/ubereats。',
